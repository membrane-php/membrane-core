...
class MatrixTest extends MembraneTestCase
{
    #[Test]
    public function toStringTest(): void
    {
        $expected = 'format matrix style value';
        $sut = new Matrix('string', true);
    ...
    public function itOnlyFiltersStrings(mixed $value): void
    {
        $expected = Result::invalid($value, new MessageSet(null, new Message(
            'Matrix Filter expects string, %s given',
            [gettype($value)],
        )));
    ...
    #[Test]
    #[DataProvider('provideMatrixStringsToFilter')]
    public function itFiltersQueryStrings(
        ...
        $sut = new Matrix($type->value, $explode);
     ...
     * }>
     */
    public static function provideMatrixStringsToFilter(): Generator
    {
