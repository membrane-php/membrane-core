...
use Membrane\Filter\String\ToLowerCase;
...
class ToLowerCaseTest extends TestCase
{
    ...
    public function itInvalidatesNonStringValues(): void
    {
        ...
        self::assertEquals($expected, (new ToLowerCase())->filter($nonStringValue));
    }

    #[Test]
    #[TestDox('It filters strings to lower case')]
    #[DataProvider('provideStringsToFilter')]
    public function itFiltersStrings(Result $expected, string $value): void
    {
        self::assertEquals($expected, (new ToLowerCase())->filter($value));
    }
