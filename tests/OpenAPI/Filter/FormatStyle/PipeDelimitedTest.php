...
#[CoversClass(PipeDelimited::class)]
#[UsesClass(HumanReadable::class)]
#[UsesClass(Message::class)]
#[UsesClass(MessageSet::class)]
#[UsesClass(Result::class)]
class PipeDelimitedTest extends MembraneTestCase
{
    #[Test]
    public function toStringTest(): void
    {
        $expected = 'format pipeDelimited style value';
        $sut = new PipeDelimited();
    ...
    public function itOnlyFiltersStrings(mixed $value): void
    {
        $expected = Result::invalid($value, new MessageSet(null, new Message(
            'PipeDelimited Filter expects string, %s given',
            [gettype($value)],
        )));
    ...
    #[Test]
    #[DataProvider('providePipeDelimitedStringsToFilter')]
     ...
     * }>
     */
    public static function providePipeDelimitedStringsToFilter(): Generator
    {
